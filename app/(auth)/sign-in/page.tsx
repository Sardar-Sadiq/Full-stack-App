...
//if u use the ()--> this brackets in ur arrow function means, u dotn need the return to write becoz javascript knows if use this () means in that matter will be automatically return
